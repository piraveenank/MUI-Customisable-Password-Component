...
var MUI_CustomisablePasswordComponent = function (_a) {
    ...
    var passwordRequirementDefinitions = (0, react_1.useMemo)(function () {
    ...
    var enabledRules = Object.keys(rules).length === 0
        ...
        : Object.keys(rules).filter(function (rule) {
            return Boolean(passwordRequirementDefinitions[rule]);
        });
    var filteredObject = Object.fromEntries(Object.entries(passwordRequirementDefinitions).filter(function (_a) {
        var key = _a[0];
    ...
    var calculatePasswordStrength = function () {
        var fulfilledRulesCount = enabledRules.reduce(function (count, rule) {
            return passwordRequirementDefinitions[rule].valid
                ? count + 1
                : count;
        }, 0);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [passwordStrengthBar && ((0, jsx_runtime_1.jsx)(material_1.LinearProgress, { variant: "determinate", value: passwordStrength, sx: {
                ...
                var _a = passwordRequirementDefinitions[rule], label = _a.label, valid = _a.valid;
...
exports.default = MUI_CustomisablePasswordComponent;
